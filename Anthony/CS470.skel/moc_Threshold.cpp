...
QT_MOC_LITERAL(1, 10, 9), // "changeThr"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "Threshold\0changeThr\0"
};
...
void Threshold::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeThr((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject Threshold::staticMetaObject = { {
    &ImageFilter::staticMetaObject,
    qt_meta_stringdata_Threshold.data,
