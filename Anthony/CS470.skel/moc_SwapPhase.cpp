...
void SwapPhase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SwapPhase *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SwapPhase::staticMetaObject = { {
    &ImageFilter::staticMetaObject,
    qt_meta_stringdata_SwapPhase.data,
    qt_meta_data_SwapPhase,
    qt_static_metacall,
    nullptr,
    nullptr
} };
