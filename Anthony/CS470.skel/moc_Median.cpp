...
QT_MOC_LITERAL(1, 7, 10), // "changeSize"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 10) // "changeItrs"

    },
    "Median\0changeSize\0\0changeItrs"
};
...
void Median::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Median *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeSize((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->changeItrs((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject Median::staticMetaObject = { {
    &ImageFilter::staticMetaObject,
    qt_meta_stringdata_Median.data,
    qt_meta_data_Median,
    qt_static_metacall,
    nullptr,
    nullptr
